...
describe 'basic installation' do
  ...
  context 'with basic parameters' do
    ...
    describe command("podman run --rm --network=iop-core-network quay.io/iop/advisor-backend:foreman-3.18 curl -s -o /dev/null -w '%{http_code}' http://iop-service-advisor-backend-service:8000/api/insights/v1/status/live/") do
