...
describe 'basic installation' do
  ...
  context 'with basic parameters' do
    ...
    describe command("podman run --rm --network=iop-core-network quay.io/iop/vmaas:foreman-3.18 curl -s -o /dev/null -w '%{http_code}' http://iop-service-vmaas-reposcan:8000/healthz") do
