...
describe 'basic installation' do
  ...
  context 'with basic parameters' do
    ...
    describe command("podman run --rm --network=iop-core-network quay.io/iop/remediations:foreman-3.18 curl -s -o /dev/null -w '%{http_code}' http://iop-service-remediations-api:9002/health") do
